...
from cellvit.training.base_ml.base_validator import sweep_schema
from cellvit.utils.logger import Logger
from cellvit.utils.tools import flatten_dict, remove_parameter_tag, unflatten_dict
...
class BaseExperiment:
    ...
    def __init__(
        ...
        self.just_load_model: bool = just_load_model
