...
from cellvit.training.datasets.monuseg import MoNuSegDataset
from cellvit.training.evaluate.cellpostprocessor import CellPostProcessor
...
class MoNuSegInference:
    ...
    def __get_model(self, model_type: str) -> Union[CellViT, CellViT256, CellViTSAM]:
