...
from pathopatch.utils.deepzoom import DeepZoomGenerator
...
def compute_interesting_patches(
    ...
    Args:
        slide (tiffslide.TiffSlide): Slide as TiffSlide object. Used to get metadata
...
def generate_thumbnails(
    ...
    Args:
        slide (TiffSlide): Slide to retrieve thumbnails from.
