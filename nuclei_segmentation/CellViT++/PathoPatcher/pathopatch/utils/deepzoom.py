...
TiffSlide objects. Adapted from OpenSlide's implementation.
"""
...
# Constants from openslide that we need
...
class DeepZoomGenerator:
    ...
    BOUNDS_OFFSET_PROPS = (PROPERTY_NAME_BOUNDS_X, PROPERTY_NAME_BOUNDS_Y)
    BOUNDS_SIZE_PROPS = (PROPERTY_NAME_BOUNDS_WIDTH, PROPERTY_NAME_BOUNDS_HEIGHT)

    def __init__(
        self,
        osr,  # Type hint as tiffslide.TiffSlide
        tile_size: int = 254,
        overlap: int = 1,
