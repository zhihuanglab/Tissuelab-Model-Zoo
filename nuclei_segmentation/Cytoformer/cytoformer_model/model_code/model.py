...
class CellClassifier(nn.Module):
    def __init__(self, organ_names=ORGANS, backbone="uni2", freeze_backbone=False):
        super().__init__()
        self.organ_names = list(organ_names)
        self.uni_encoder = build_backbone(backbone, freeze=freeze_backbone)   # attr name kept for ckpt compat
    ...
    def extract_features(self, img224, organ_ids=None):
        return self.feat_norm(self.uni_encoder(img224))
