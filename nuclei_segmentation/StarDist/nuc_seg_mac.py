        ...
        while True:
            ...
            if data is None:
                ...
                if predict_duration > 5.0:
                    print(f"[WARNING]  WARNING: StarDist prediction took {predict_duration:.2f}s (likely CPU-only mode)")
                    print(f"    Expected GPU time: 0.5-2s. Check TensorFlow GPU installation!")
                else:
                    print(f"[OK] StarDist prediction: {predict_duration:.2f}s (GPU acceleration confirmed)")
        ...
        for ir in range(n_row):
            for ic in range(n_col):
                ...
                if predict_duration > 5.0:
                    ...
                    print(f"[OK] StarDist prediction: {predict_duration:.2f}s (GPU acceleration likely active)")
