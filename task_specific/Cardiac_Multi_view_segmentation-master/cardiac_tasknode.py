...
def process_segmentation_sync(input_path: str, view_name: str, device: str = "gpu"):
    ...
    logger.info(f"[Process] Starting segmentation for view: {view_name}")
    logger.info(f"[Process] Input path: {input_path}")
    logger.info(f"[Process] Device: {device}")
    print(f"[Process] Starting segmentation for view: {view_name}")
    print(f"[Process] Input path: {input_path}")
